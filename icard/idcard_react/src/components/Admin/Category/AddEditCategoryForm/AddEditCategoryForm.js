...
export function AddEditCategoryForm(props) {
    ...
    // condicion especifica para identificar si algunos navegadores son compatibles con MIME
    // const mimeType = "image/jpeg"; // Tipo MIME que deseas verificar

    // if (navigator.mimeTypes && navigator.mimeTypes[mimeType] && navigator.mimeTypes[mimeType].enabledPlugin) {
    // console.log(`${mimeType} es compatible en este navegador.`);
    // } else {
    // console.log(`${mimeType} no es compatible en este navegador.`);
    // }
